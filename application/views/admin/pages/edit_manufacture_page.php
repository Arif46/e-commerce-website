...
<div class="row-fluid sortable">
    <div class="box span12">
        ...
        <div class="box-content">
            ...
            <form name="edit_manufacture" class="form-horizontal" action="<?php echo base_url() ?>Super_Admin/update_manufacture" method="post" enctype="multipart/form-data">
                <fieldset>
                    ...
                    <div class="control-group hidden-phone">
                        ...
                        <div class="controls">
                            <textarea name="manufacture_description" class="cleditor" id="textarea2" rows="3"><?php echo $select_manufacture->manufacture_description?></textarea>
                        </div>
                    </div>
                    <div class="control-group">
