...
<div class="row-fluid sortable">
    <div class="box span12">
        ...
        <div class="box-content">
            ...
            <form class="form-horizontal" action="<?php echo base_url() ?>Super_Admin/save_silders" method="post" enctype="multipart/form-data">
                <fieldset>
                    <div class="control-group">
                        <label class="control-label" for="typeahead">Sliders Name</label>
                        <div class="controls">
                            <input type="text" name="sliders_name" class="span6 typeahead" id="typeahead"  data-provide="typeahead" data-items="4" >
                        </div>
                    </div>
