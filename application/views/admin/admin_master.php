        ...
        <script type="text/javascript">
            ...
            <script type="text/javascript">
                function manufactureDelete(){
                    var msg=confirm("Are you sure delete this!!!");
                    if(msg){
                        return true;
                    }else{
                        return false;
                    ...
                    <div class="nav-collapse sidebar-nav">
                        <ul class="nav nav-tabs nav-stacked main-menu">
                            ...
                            <li>
                              ...
                              <li>
                                <a class="dropmenu" href="#"><i class="icon-folder-close-alt"></i><span class="hidden-tablet">Sliders</span> <span class="label label-important"> 2 </span></a>
                                <ul>
                                    <li><a class="submenu" href="<?php echo base_url()?>Super_Admin/add_sliders"><i class="icon-file-alt"></i><span class="hidden-tablet">Add sliders</span></a></li>
                                    <li><a class="submenu" href="<?php echo base_url()?>Super_Admin/manage_sliders"><i class="icon-file-alt"></i><span class="hidden-tablet">Manage sliders</span></a></li>
                                </ul>	
                            </li>
                              <li>
                            ...
                            <li><a href="<?php echo base_url()?>Super_Admin/manage_order"><i class="icon-envelope"></i><span class="hidden-tablet"> Customer Order</span></a></li>
