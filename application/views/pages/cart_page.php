                        ...
                        foreach ($this->cart->contents() as $items) {
                            ...
                            <tr>
                                ...
                                <td data-title="Product Image &amp; name" class="t_md_align_c">
                                    <img width="90" src="<?php echo base_url().$items['image'] ?>" alt="" class="m_md_bottom_5 d_xs_block d_xs_centered">
                                    <a href="#" class="d_inline_b m_left_5 color_dark"><?php echo $items['name'] ?></a>
                                </td>
                                <!--product key-->
                                ...
                                <td data-title="Quantity">
                                    ...
                                    <form action="<?php echo base_url();?>Cart/update_cart/<?php echo $items['rowid'] ?>" method="post">
                                        <input type="number" name="qty"  value="<?php echo $items['qty'] ?>">
                                        <br><br>
                                        <i class="fa fa-check f_size_medium m_right_5"></i><input type="submit"min="1" value="Update">
                                    </form>
                                    <!--                                <div class="clearfix quantity r_corners d_inline_middle f_size_medium color_dark m_bottom_10">
                                                                        <button class="bg_tr d_block f_left" data-direction="down">-</button>
                                                                        <input type="text" name="qty" readonly value="<?php echo $items['qty'] ?>" class="f_left">
                                                                        <button class="bg_tr d_block f_left" data-direction="up">+</button>
                                                                    </div>-->
                                    <div>
                                        <!--<a href="#" class="color_dark"><i class="fa fa-check f_size_medium m_right_5"></i>Update</a><br>-->
                                        <a href="<?php echo base_url();?>Cart/remove_cart/<?php echo $items['rowid'] ?>" class="color_dark"><i class="fa fa-times f_size_medium m_right_5"></i>Remove</a><br>
...
<!--                                    <input type="text" placeholder="Enter your coupon code" name="" class="r_corners f_size_medium">
                        ...
                        <tr>
                            <td>
                                <a href="<?php echo base_url() ?>Welcome"><button class="button_type_6 bg_scheme_color f_size_large r_corners tr_all_hover color_light m_bottom_20">Continue Shopping</button></a>
                            </td>
                            <td>
